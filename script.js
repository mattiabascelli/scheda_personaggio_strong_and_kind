...
function creaPdf() {
    ...
    doc.setFontSize(10);
    doc.text(20, 190, '[    ] Sacco a Pelo____________________[    ]______________________________________');
    doc.text(20, 200, '[    ] Pietra Focaia___________________[    ]______________________________________');
    doc.text(20, 210, '[    ] ________________________________[    ]______________________________________');
